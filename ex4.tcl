# thread.tcl
# A test script to learn how to use threads to manage an LED display with multiple display events
# vh, 9 May 2017
...
# Create a path (see ex1.tcl for an explanation of how this path was created) 
...
set colours [list white red pink orange yellow green blue indigo violet purple grey]

# Start this path display in each of the threads, starting one every second.
foreach i [lsort -integer -increasing [array names threads]] {
	...
	set command [list device display -path $path -fg_colour $colour -record path1]
